    ...
    className='w-full h-screen bg-white text-black flex justify-center items-center p-4'>
      <form action="" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          ...
          <p className='py-4'>// Submit the form below or shoot me an email - 640101030029@dpu.ac.th</p>
        </div>
        ...
        <button className='mt-5 mx-auto p-3 rounded-[10px] border-2 border-black hover:bg-black hover:text-white duration-700'>Let's Collaborate</button>
      </form>
    </div>
  )
}
